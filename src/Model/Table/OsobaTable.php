 ...
 * Osoba Model
 *
 * @method \App\Model\Entity\Osoba get($primaryKey, $options = [])
 * @method \App\Model\Entity\Osoba newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\Osoba[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\Osoba|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
