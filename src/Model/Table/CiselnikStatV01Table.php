...
class CiselnikStatV01Table extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('ciselnik_stat_v01');
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->requirePresence('statKodOmezeny', 'create')
            ->notEmpty('statKodOmezeny');
        ...
        $validator
            ->requirePresence('statCiselnikAxisStatKod', 'create')
            ->notEmpty('statCiselnikAxisStatKod');
