...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $ciselnikMmrOperacniProgramv01->idOperacniProgram],
                ['confirm' => __('Are you sure you want to delete # {0}?', $ciselnikMmrOperacniProgramv01->idOperacniProgram)]
            )
        ?></li>
...
<div class="ciselnikMmrOperacniProgramv01 form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Ciselnik Mmr Operacni Programv01') ?></legend>
        <?php
