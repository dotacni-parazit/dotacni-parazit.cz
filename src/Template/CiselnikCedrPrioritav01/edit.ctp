...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $ciselnikCedrPrioritav01->idPriorita],
                ['confirm' => __('Are you sure you want to delete # {0}?', $ciselnikCedrPrioritav01->idPriorita)]
            )
        ?></li>
...
<div class="ciselnikCedrPrioritav01 form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Ciselnik Cedr Prioritav01') ?></legend>
        <?php
