...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $ciselnikRozpoctovaSkladbaParagrafv01->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $ciselnikRozpoctovaSkladbaParagrafv01->id)]
            )
        ?></li>
...
<div class="ciselnikRozpoctovaSkladbaParagrafv01 form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Ciselnik Rozpoctova Skladba Paragrafv01') ?></legend>
        <?php
