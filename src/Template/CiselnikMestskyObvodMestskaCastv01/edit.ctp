...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $ciselnikMestskyObvodMestskaCastv01->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $ciselnikMestskyObvodMestskaCastv01->id)]
            )
        ?></li>
...
<div class="ciselnikMestskyObvodMestskaCastv01 form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Ciselnik Mestsky Obvod Mestska Castv01') ?></legend>
        <?php
