...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $ciselnikMmrGrantoveSchemav01->idGrantoveSchema],
                ['confirm' => __('Are you sure you want to delete # {0}?', $ciselnikMmrGrantoveSchemav01->idGrantoveSchema)]
            )
        ?></li>
...
<div class="ciselnikMmrGrantoveSchemav01 form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Ciselnik Mmr Grantove Schemav01') ?></legend>
        <?php
