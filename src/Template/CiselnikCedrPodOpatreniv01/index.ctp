...
<div class="ciselnikCedrPodOpatreniv01 index large-9 medium-8 columns content">
    <h3><?= __('Ciselnik Cedr Pod Opatreniv01') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            <?php foreach ($ciselnikCedrPodOpatreniv01 as $ciselnikCedrPodOpatreniv01): ?>
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $ciselnikCedrPodOpatreniv01->idPodOpatreni]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $ciselnikCedrPodOpatreniv01->idPodOpatreni]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $ciselnikCedrPodOpatreniv01->idPodOpatreni], ['confirm' => __('Are you sure you want to delete # {0}?', $ciselnikCedrPodOpatreniv01->idPodOpatreni)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
